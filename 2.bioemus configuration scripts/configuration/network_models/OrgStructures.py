...
nrncode     = { NRN_EXC: "RSorg",   # Excitatory neuron is customized RS from "HHparam.py" <EDIT>
...
class OrgStructures:
    ...
    def genNeurons(self, inh_ratio):
        ...
        # TODO : add generic depending on _nb_orgs
        self.x_all      =  self.x[0]      + self.x[1]
        self.y_all      =  self.y[0]      + self.y[1]
        self.dist2c_all =  self.dist2c[0] + self.dist2c[1]
        self.tnrn_all   =  self.tnrn[0]   + self.tnrn[1]
        self.nlist_all  =  self.nlist[0]  + self.nlist[1]
