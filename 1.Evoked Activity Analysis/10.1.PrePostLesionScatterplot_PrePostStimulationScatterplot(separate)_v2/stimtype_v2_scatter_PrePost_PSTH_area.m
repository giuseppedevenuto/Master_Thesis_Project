...
exportgraphics(groups_scatter_PSTHarea_figure,fullfile(StimType_PrePost_PSTHareagraph_scatter_directory,"PSTHarea_orizzontale.png"),'Resolution',500)
groups_scatter_PSTHarea_figure.Visible="on";
saveas(groups_scatter_PSTHarea_figure,fullfile(StimType_PrePost_PSTHareagraph_scatter_directory,"PSTHareas_orizzontale.fig"))
