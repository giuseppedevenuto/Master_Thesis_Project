% tutti et1 con tutti sham confrontando il prelesione con il post
% stimolazione perche il post-lesione non c'è negli altri sham 
% (non ha molto senso perche le stimolazioni sono diverse e
% quindi è da buttare)
...
for l=1:2
    ...
    for n=1:nareas_x_nmapping
        ...
        datatoplot{n,1}(:,2:end-1)=[];
        datatoplot{n,3}(2:end-1,:)=[];
